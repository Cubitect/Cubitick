...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void runGameLoop() throws IOException
    {
        ...
        if (!this.skipRenderWorld)
        {
            ...
            this.entityRenderer.updateCameraAndRender(this.timerWorld.renderPartialTicks, System.nanoTime());
            this.mcProfiler.endSection();
        }
    ...
    /**
     * Runs the current tick; i.e. original runTick()
     */
    ...
    private void runTickMouse() throws IOException
    {
        while (Mouse.next())
        {
            ...
            // Cubitick: tickrate fix to mouse wheel input
            if (j <= (long)Math.max(200F*(Cubitick.tickrate/Cubitick.tickrateWorld), 200L))
            {

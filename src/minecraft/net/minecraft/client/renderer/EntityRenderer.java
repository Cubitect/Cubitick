...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void renderWorld(float p_78471_1_, long p_78471_2_)
    {
        ...
        if (this.mc.gameSettings.anaglyph)
        {
            ...
            if(Cubitick.synctick) this.func_175068_a(0, p_78471_1_, p_78471_2_);
            else this.func_175068_a_Async(0, mc.timer.renderPartialTicks, mc.timerWorld.renderPartialTicks, p_78471_2_);
            anaglyphField = 1;
            GlStateManager.colorMask(true, false, false, false);
            if(Cubitick.synctick) this.func_175068_a(1, p_78471_1_, p_78471_2_);
            else this.func_175068_a_Async(1, mc.timer.renderPartialTicks, mc.timerWorld.renderPartialTicks, p_78471_2_);
            GlStateManager.colorMask(true, true, true, false);
        }
        else
        {
            if(Cubitick.synctick) this.func_175068_a(2, p_78471_1_, p_78471_2_);
            else this.func_175068_a_Async(2, mc.timer.renderPartialTicks, mc.timerWorld.renderPartialTicks, p_78471_2_);
        }
    ...
    // Cubitick: clone of func_175068_a(), adapted to work with separate player and world tick interpolations
    private void func_175068_a_Async(int p_175068_1_, float ptick, float wtick, long p_175068_3_)
    {
        RenderGlobal var5 = this.mc.renderGlobal;
        EffectRenderer var6 = this.mc.effectRenderer;
        boolean var7 = this.func_175070_n();
        ...
        GlStateManager.clear(16640);
        this.mc.mcProfiler.endStartSection("camera");
        this.setupCameraTransform(ptick, p_175068_1_);
        ActiveRenderInfo.updateRenderInfo(this.mc.thePlayer, this.mc.gameSettings.thirdPersonView == 2);
        this.mc.mcProfiler.endStartSection("frustum");
        ClippingHelperImpl.getInstance();
        this.mc.mcProfiler.endStartSection("culling");
        Frustrum var8 = new Frustrum();
        Entity var9 = this.mc.func_175606_aa();
        double var10 = var9.lastTickPosX + (var9.posX - var9.lastTickPosX) * (double)ptick;
        double var12 = var9.lastTickPosY + (var9.posY - var9.lastTickPosY) * (double)ptick;
        ...
        if (this.mc.gameSettings.renderDistanceChunks >= 4)
        {
            ...
            GlStateManager.matrixMode(5888);
            var5.func_174976_a(ptick, p_175068_1_);
            GlStateManager.matrixMode(5889);
            GlStateManager.loadIdentity();
            Project.gluPerspective(this.getFOVModifier(ptick, true), (float)this.mc.displayWidth / (float)this.mc.displayHeight, 0.05F, this.farPlaneDistance * MathHelper.field_180189_a);
            GlStateManager.matrixMode(5888);
        }
        ...
        if (var9.posY + (double)var9.getEyeHeight() < 128.0D)
        {
            this.func_180437_a(var5, ptick, p_175068_1_);
        }
        ...
        GlStateManager.pushMatrix();
        GlStateManager.disableAlpha();
        var5.func_174977_a(EnumWorldBlockLayer.SOLID, (double)ptick, p_175068_1_, var9);
        GlStateManager.enableAlpha();
        var5.func_174977_a(EnumWorldBlockLayer.CUTOUT_MIPPED, (double)ptick, p_175068_1_, var9);
        this.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).func_174936_b(false, false);
        var5.func_174977_a(EnumWorldBlockLayer.CUTOUT, (double)ptick, p_175068_1_, var9);
        this.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).func_174935_a();
        GlStateManager.shadeModel(7424);
        GlStateManager.alphaFunc(516, 0.1F);
        EntityPlayer var16;
        ...
        if (!this.field_175078_W)
        {
            ...
            var5.func_180446_a(var9, var8, wtick);
            
            var9.lastTickPosX = lx;
            var9.lastTickPosY = ly;
            var9.lastTickPosZ = lz;
            ...
            if (this.mc.objectMouseOver != null && var9.isInsideOfMaterial(Material.water) && var7)
            {
                ...
                GlStateManager.disableAlpha();
                this.mc.mcProfiler.endStartSection("outline");
                var5.drawSelectionBox(var16, this.mc.objectMouseOver, 0, ptick);
                GlStateManager.enableAlpha();
            }
        }
        ...
        GlStateManager.enableBlend();
        GlStateManager.tryBlendFuncSeparate(770, 1, 1, 0);
        var5.func_174981_a(Tessellator.getInstance(), Tessellator.getInstance().getWorldRenderer(), var9, wtick);
        GlStateManager.disableBlend();
        ...
        if (!this.field_175078_W)
        {
            this.func_180436_i();
            this.mc.mcProfiler.endStartSection("litParticles");
            var6.renderLitParticles(var9, wtick);
            RenderHelper.disableStandardItemLighting();
            this.setupFog(0, wtick);
            this.mc.mcProfiler.endStartSection("particles");
            var6.renderParticles(var9, wtick);
            this.func_175072_h();
        }
        ...
        if (this.mc.gameSettings.fancyGraphics)
        {
            ...
            GlStateManager.enableBlend();
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            var5.func_174977_a(EnumWorldBlockLayer.TRANSLUCENT, (double)ptick, p_175068_1_, var9);
            GlStateManager.disableBlend();
        }
        else
        {
        ...
        {
            GlStateManager.clear(256);
            this.renderHand(ptick, p_175068_1_);
            this.func_175067_i(ptick);
        }
    }

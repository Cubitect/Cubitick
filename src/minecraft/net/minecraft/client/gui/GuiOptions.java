...
import cubimod.gui.GuiServerPackets;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        // PacketAnalysis
        GuiButton serverPacketButton = new GuiButton(136, this.width / 2 - 155, this.height / 6 + 24 - 6, 150, 20, I18n.format("Server Packet Options...", new Object[0]));
        this.buttonList.add(serverPacketButton);
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiServerPackets(this, this.game_settings_1));
            }
        }
    }
